    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='PseudomonGo.player')),
            ],
        ),
        migrations.CreateModel(
            name='Animal',
            fields=[
                ...
                ('move1', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='move1', to='PseudomonGo.move')),
                ('move2', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='move2', to='PseudomonGo.move')),
                ('move3', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='move3', to='PseudomonGo.move')),
                ('move4', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='move4', to='PseudomonGo.move')),
